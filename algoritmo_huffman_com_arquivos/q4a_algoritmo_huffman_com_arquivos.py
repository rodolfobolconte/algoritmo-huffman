...
frase_original = open("q4a_algoritmo_huffman_com_arquivos_texto_original.txt", "r").read()
...
frase_codificada_txt = open("q4a_algoritmo_huffman_com_arquivos_texto_codificado.txt", "w").writelines(frase_codificada)
